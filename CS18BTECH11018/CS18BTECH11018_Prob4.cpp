...
int counter = 0; //for component
class Graph  //class with all attributes
{
public:
	int n;
	list<int> *adjacency;
	...
	void search1(int p,int visited1[]) //for count
	{
		visited1[p] = 1;
		//cout<<p<<" ";
	...
	void search2(int p,int visited2[]) //to print
	{
		visited2[p] = 1;
		cout<<p<<" ";
		for (auto i = adjacency[p].begin(); i != adjacency[p].end();++i)
...
int main()
{
    ...
    cout<<"Enter find once and SP can be used any number of times!\n";
    cout<<"(Enter 'x' to exit the program)\n";
    //cout<<"Enter Sp as many times as required and pess 'f' to exit:";
    string f1,f2;
    int s;
    cin>>f1;
    cout<<"\n";
