...
void remove(int T)
{
    ...
    else
    {
        while(temp != NULL)
        {
            int count = 1;
            temp2 = temp->link;
            while(temp2 != NULL && (temp2->data == temp->data) || (temp2->data-32 == temp->data)||(temp2->data+32 == temp->data))
            {
            	count++;
            	temp2 = temp2->link;
            }
...
void printer()
{
    ...
    else
    {
        while(temp != NULL)
        {
            ...
            {
            	int change = 0;
            	if ((temp2->data == temp->data) || (temp2->data-32 == temp->data)||(temp2->data+32 == temp->data))
            	{
            		change = 1;
            		count++;
            	}
